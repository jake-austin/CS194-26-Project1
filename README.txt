...
WHERE IMPORTANT GRADER STUFF IS:
All the implementations of exhaustive search, pyramid search are in the "Main Code" section along with the scoring mechanisms for each alignment. I ran and got my results in the "Main" section. Bells and whistles are in the bells and whistles section. Bells and whistles runtime code is in the bells and whistles demo section
